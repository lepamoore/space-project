...
export default function Page01(props) {
	function selectPlanetImg() {
		if (props.data.destinations[props.destinationCount].name === "Moon") {
			...
			props.data.destinations[props.destinationCount].name === "Mars"
		) {
			return marsImg;
		} else if (
			props.data.destinations[props.destinationCount].name === "Europa"
		) {
			return europaImg;
		} else if (
			props.data.destinations[props.destinationCount].name === "Titan"
		) {
			return titanImg;
		}
	}
		...
		<div id="wrapper01">
			<div id="dvh100Container">
				...
				<div className="detailsContainer01" id="imgDetails01">
					...
					<img
						src={selectPlanetImg()}
						alt={props.data.destinations[props.destinationCount].name}
						id="planetImg"
					/>
				</div>
